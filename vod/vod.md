...
2. **+버킷 만들기**를 선택합니다.
3. **버킷 이름**에 대해 **vod-&lt;자신의 이름&gt;**과 같이 글로벌하게 유일한 이름을 넣어 주세요. **리전 선택** 주세요.
4. **퍼블릭 엑세스 차단을 위한 버킷 설정**에서 **모든 퍼블릭 엑세스 차단** 체크박스를 해제해 줍니다. 이후 아래 경고문의 ‘**현재 설정으로 인해 이 버킷과 그 안에 포함된 객체가 퍼블릭 상태가 될 수 있음을 알고 있습니다.**’ 체크박스를 선택해 줍니다. 이후 **버킷 만들기** 버튼을 클릭하여 버킷을 생성합니다.

![](../.gitbook/assets/screen-shot-2021-03-23-at-12.56.20-pm.png)

![](../.gitbook/assets/screen-shot-2021-03-23-at-12.57.41-pm.png)
...
5. 인덱스 문서 란에 index.html 을 넣습니다. _참고: S3는 사용 여부와 상관없이 인덱스 문서 설정을 필요로 합니다._
6. **저장**을 누릅니다.
...
![MediaConvert &#xB3D9;&#xC791;&#xC608;&#xC2DC;](../.gitbook/assets/image%20%2844%29.png)
...
3. Apple HLS 가 선택된 것을 출력 그룹의 작업 패널에서 확인하고, Apple HLS 설정 폼을 확인합니다.
...
![&#xCD9C;&#xB825;&#xC124;&#xC815; Output1](../.gitbook/assets/image%20%2827%29.png)
...
![&#xCD9C;&#xB825;&#xC124;&#xC815; Output2](../.gitbook/assets/image%20%2828%29.png)
...
![&#xCD9C;&#xB825;&#xC124;&#xC815; Output3](../.gitbook/assets/image%20%28103%29.png)
...
1. 전 모듈에서 만든 미디어 버킷 vod-&lt;자신의 이름&gt;으로 들어갑니다.
2. **assets** 폴더를 선택하고, **작업** 드롭다운 메뉴에서 **퍼블릭으로 설정**을 클릭합니다.

![](../.gitbook/assets/screen-shot-2021-03-23-at-1.20.31-pm.png)

1. **/assets/VANLIFE/** 안의 master manifest 파일인 HLS.m3u8의 객체 URL을 확인합니다.
...
![/var/folders/qy/8sfk8h6x4dqcplg52d1pp8smzs35t9/T/com.microsoft.Word/Content.MSO/A079D87D.tmp](../.gitbook/assets/18.jpeg)_역할을 사용할 서비스를 선택하게 되면 AWS 서비스가 사용자 대신 특정한 역할을 맡을 수 있도록 역할에 대한 신뢰 정책이 자동으로 만들어집니다. 만약 CLI 또는 AWS CloudFormation를 이용하여 이 역할을 생성하고 있으신 경우, 직접 신뢰 정책을 구성해 주어야 합니다._
...
![&#xC815;&#xCC45;&#xCD94;&#xAC00;&#xB41C; VODLambdaRole](../.gitbook/assets/image%20%28119%29.png)
