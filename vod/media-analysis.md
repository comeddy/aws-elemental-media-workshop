...
![](<../.gitbook/assets/screen-shot-2021-03-16-at-8.19.58-pm (2) (2).png>)
...
![](<../.gitbook/assets/screen-shot-2021-03-16-at-8.34.27-pm (1).png>)
...
![](<../.gitbook/assets/screen-shot-2021-03-16-at-8.34.27-pm (1) (1).png>)
...
2. 트랜스코딩 작업이 끝날 때까지 잠시 기다립니다.\
   최근 작업 페이지의 **새로 고침**을 눌러 작업 상태가 complete로 변경된 것을 확인하면, **서비스** **데이터베이스** **DynamoDB**를 차례로 눌러 DynamoDB 콘솔로 들어갑니다.
